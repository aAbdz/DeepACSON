...
# Training
Install Elktronn as instructed in https://github.com/ELEKTRONN
The network can be trained with the train.py script, which expects .h5 files as training materials.

# Inference
Assign the address to .mdl file
