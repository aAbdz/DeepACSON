...
# -*- coding: utf-8 -*-
"""
Created on Tue Jun  9 16:18:47 2020
...
read_fname_axon = 'mat_objs1.mat'
read_fname_skeleton = 'skeletons_01'
...
save_log_file = os.path.join(save_dir, 'log_file_0.txt')
...
if __name__ == '__main__':
    ...
    for ii in range(0, len(chunks)):
        ...
        save_file = os.path.join(save_dir, 'analysis_1_')
        save_file = save_file + str(counter) + '.pickle'
